...
class Enricher {
  ...
  EnrichedRecept enrichRecipe(Recept recept) {
    ...
    var image120x120 = getImage(recept.base64Image, 120);
    var image300x300 = getImage(recept.base64Image, 300);
  ...
  Image getImage(String? origBase64String, int size) {
    if (origBase64String == null || origBase64String.isEmpty) {
      ...
      var resizedBase64Stringh = resizeImage(defaultImage,size);
      var image = Image.memory(base64Decode(resizedBase64Stringh));
      return image;
    }
    var resizedBase64Stringh = resizeImage(origBase64String, size);
    var image = Image.memory(base64Decode(resizedBase64Stringh));
    return image;
  }
