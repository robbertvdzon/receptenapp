...
class _WidgetState extends State<ReceptEditPage> {
  ...
  String? _base64Image80pixels = null;
  var _recipesService = getIt<RecipesService>();

  _WidgetState(EnrichedRecept recept) {
    this._recept = recept;
    this._newRecept = recept.recept;
    this._base64Image80pixels = _recept.recept.base64Image80pixels;
  }

  _saveRecept() {
    _newRecept.base64Image80pixels = _base64Image80pixels;
    _recipesService
        ...
        body: Center(
          ...
          children: <Widget>[
            Container(
              ...
              child: getImage(_base64Image80pixels),
            ),
            ElevatedButton(
