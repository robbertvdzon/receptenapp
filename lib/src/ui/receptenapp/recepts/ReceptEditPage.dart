...
class _WidgetState extends State<ReceptEditPage> {
  ...
  String? _base64Image300x300 = null;
  String? _base64Image120x120 = null;
  var _recipesService = getIt<RecipesService>();

  _WidgetState(EnrichedRecept recept) {
    this._recept = recept;
    this._newRecept = recept.recept;
    this._base64Image300x300 = _recept.recept.base64Image300x300;
    this._base64Image120x120 = _recept.recept.base64Image120x120;
  }

  _saveRecept() {
    _newRecept.base64Image120x120 = _base64Image120x120;
    _newRecept.base64Image300x300 = _base64Image300x300;
    _recipesService
  ...
  void _getClipboard() async {
    ...
    if (bytes != null) {
      ...
      setState(() {
        _base64Image120x120 = resizeImage(data,120);
        _base64Image300x300 = null;
        // _base64Image300x300 = resizeImage(data,300);
      });
    }
  }
        ...
        body: Center(
          ...
          children: <Widget>[
            Container(
              ...
              child: getImage(_base64Image300x300,300),
            ),
            Container(
              alignment: Alignment.topLeft,
              // use aligment
              ...
              // child: Image.asset('assets/images/recipes/'+_recept.localImageName,
              //     height: 100, width: 100, fit: BoxFit.cover),
              child: getImage(_base64Image120x120,300),
            ),
            ElevatedButton(
  ...
  Image getImage(String? origBase64String, int size) {
